...
def pull_data(filename):
    """opens file and returns lines as lists"""
    ...
    for line in data:
        ...
        cohort_info.append(person_info)
...
def unique_houses(filename):
    ...
    # Code goes here
    cohort_info = pull_data(filename)
